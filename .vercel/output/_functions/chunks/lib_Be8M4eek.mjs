...
var require_libvips = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var detectLibc$1 = __require("detect-libc");
	...
	var runtimeLibc = () => detectLibc$1.isNonGlibcLinuxSync() ? detectLibc$1.familySync() : "";
...
var require_sharp = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	SPDX-License-Identifier: Apache-2.0
	*/
	var { familySync, versionSync } = __require("detect-libc");
...
var require_utility = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	...
	var detectLibc = __require("detect-libc");
	var is = require_is();
