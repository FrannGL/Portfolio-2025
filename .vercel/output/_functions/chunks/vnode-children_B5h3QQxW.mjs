...
var D = /* @__PURE__ */ new Set([
	...
	"track",
	"wbr"
]), x = /* @__PURE__ */ new Set(["script", "style"]), o = /(?:<(\/?)([a-zA-Z][a-zA-Z0-9\:-]*)(?:\s([^>]*?))?((?:\s*\/)?)>|(<\!\-\-)([\s\S]*?)(\-\->)|(<\!)([\s\S]*?)(>))/gm, b = /[\@\.a-z0-9_\:\-]/i;
function I(e) {
	let t = {};
	if (e) {
		let i = "none", r, n = "", a, l;
...
//#endregion
//#region node_modules/.pnpm/@astrojs+react@6.0.0_@types_17767aec3439d0c048f2c5252ce456ff/node_modules/@astrojs/react/dist/vnode-children.js
var ids = 0;
