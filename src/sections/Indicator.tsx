...
const Indicator = ({ value, label, iconName }: IndicatorProps) => {
  return (
    <div className="flex flex-col items-center justify-center py-2 gap-1 bg-[#101010] border border-[rgba(33,33,33,0.8)] text-foreground rounded-xl">
      <div className="text-5xl md:text-6xl xl:text-4xl font-semibold bg-linear-to-b from-white to-zinc-900 bg-clip-text text-transparent">
